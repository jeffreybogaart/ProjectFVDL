...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Product bewerken - {{ $product->name }} </h4><br><br>
            

            <form class="row g-3" method="post" action="{{ route('product.update') }}" id="myForm" >
                @csrf
                ...
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        <label for="leverancier" class="form-label">Leverancier</label>
                        <select name="leverancier_id" class="form-select" aria-label="Default select example">
                            ...
                            @foreach ($leverancier as $supp )
                            <option value="{{ $supp->id }}" {{ $supp->id == $product->leverancier_id ? 'selected' : ''}}>{{ $supp->naam }}</option> 
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input name="article_no" value="{{ $product->article_no }}" class="form-control" type="text">
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="categorie_id" class="form-select" aria-label="Default select example">
                            ...
                            <option value="{{ $ctg->id }}" {{ $ctg->id == $product->category_id ? 'selected' : '' }}>{{ $ctg->naam }}</option> 
                            @endforeach
                        </select>
                    </div>

                    <div class="form-group mb-3">
                        <label for="eenheid" class="form-label">Eenheid <- nog niet zeker?</label>
                        <select name="eenheid_id" class="form-select" aria-label="Default select example">
                            ...
                            @foreach ($eenheid as $eh )
                            <option value="{{ $eh->id }}"{{ $eh->id == $product->eenheid_id ? 'selected' : '' }}>{{ $eh->naam }}</option> 
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input name="p_price" value="{{ $product->p_price }}" class="form-control" type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input name="s_price" value="{{ $product->s_price }}" class="form-control" type="text">
                        </div>
                    </div>
