...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    <h4 class="mb-sm-0">Dashboard - Welkom {{ Auth::user()->name }}</h4>

    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            <li class="breadcrumb-item"><a href="javascript: void(0);">Fred van der Linden Montage</a></li>
    ...
    <div class="card-body">
        <div class="d-flex">
            <div class="flex-grow-1">
                <p class="text-truncate font-size-14 mb-2">Totale opdrachten</p>
                <h4 class="mb-2">283</h4>
...
<div class="card">
    <div class="card-body">
        <div class="d-flex">
            <div class="flex-grow-1">
                <p class="text-truncate font-size-14 mb-2">Nieuwe opdrachten</p>
                <h4 class="mb-2">3</h4>
...
<div class="card">
    <div class="card-body">
        <div class="d-flex">
            <div class="flex-grow-1">
                <p class="text-truncate font-size-14 mb-2">Placeholder</p>
                <h4 class="mb-2">---</h4>
...
<div class="card">
    <div class="card-body">
        <div class="d-flex">
            ...
            <div class="avatar-sm">
                <span class="avatar-title bg-light text-failed rounded-3">
                    <i class="mdi mdi-tooltip-question-outline font-size-24"></i>  
                </span>
            </div>
        </div>                                              
    </div><!-- end cardbody -->
...
<div class="card">
    <div class="card-body">
        ...
        <h4 class="card-title mb-4">Laatste offertes</h4>
