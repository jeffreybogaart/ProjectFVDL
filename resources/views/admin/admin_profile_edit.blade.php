...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Profiel bewerken - {{ $editData->name }} </h4>
            
            <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                @csrf

            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Naam</label>
                <div class="col-sm-10">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Gebruikersnaam</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Profielfoto </label>
                <div class="col-sm-10">
       <input name="profile_image" class="form-control" type="file"  id="image">
            ...
            <!-- end row -->
<input type="submit" class="btn btn-primary waves-effect waves-light" value="Profiel opslaan">
            </form>
